...
WORDS_FILE = 'Dictionary 3 Letter Words.txt'
...
def tests() -> None:
    ...
    if select_characters(True) == "testdatas":
    ...
    if len(read_dictionary("Dictionary 3 Letter Words.txt")) == 235887:
        print("read_dictionary test: PASSED")
    else:
        print("read_dictionary test: FAILED")
    # check that the lookup can find anagrams
    if "rat" in word_lookup("tar"):
